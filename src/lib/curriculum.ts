...
// ---------------------------------------------------------------------------
// Flagship path: Introduction to Biology via OpenStax Biology 2e (CC BY 4.0 —
// freely hostable with attribution), with MIT OpenCourseWare lectures as a
// secondary resource.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Flagship path: Principles of Economics via OpenStax Principles of Economics
// 3e (CC BY 4.0), with MIT OpenCourseWare microeconomics lectures as a
// secondary resource.
// ---------------------------------------------------------------------------
